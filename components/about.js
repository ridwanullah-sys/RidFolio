...
export const About = () => {
    return (
        <div className="w-full flex flex-col items-center ">
            ...
            <div className="text-center sm:w-[40rem] my-4 font-semibold text-stone-100">
                As a proficient website developer, I have some expertise creating websites, web
                apps, and dapps. I am an avid user of javascript and python and several frameworks
                such as nextjs and django. I have demonstrated interpersonal abilities and am
                skilled at working with people while simultaneously being able to act independently.
                I have experience using creative problem-solving techniques and negotiating to get a
                win-win outcome. I always have a strong desire to grow and take on new tasks.
            </div>
